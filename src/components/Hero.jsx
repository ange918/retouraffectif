...
const Hero = () => {
  return (
    <section
      id="accueil"
      className="bg-vert-clair pt-20 sm:pt-24 pb-12 sm:pb-16 animate-section"
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 space-y-4 sm:space-y-6">
            <p className="text-vert-profond font-medium text-sm sm:text-base">
              Marabout France : Dah Amayon
            </p>
            ...
            <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed">
              Vous souffrez d'une rupture douloureuse ou d'un éloignement de
              l'être aimé ? Le retour affectif est une solution spirituelle
              puissante pour reconquérir l'amour perdu, stopper une infidélité
              ou raviver la passion.
            </p>
            <p className="text-gray-700 text-xs sm:text-sm lg:text-base leading-relaxed">
              En tant que marabout spécialisé dans le retour affectif en France,
              je mets à votre disposition des rituels ancestraux, des prières
              puissantes et des travaux énergétiques pour agir rapidement sur
