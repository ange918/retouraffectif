    ...
    <section className="py-20 bg-vert-clair animate-section">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-playfair font-bold text-vert-profond mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <div className="flex items-center justify-center mb-6">
              ...
              <a 
                ...
                className="text-4xl font-bold text-vert-profond hover:text-dore transition"
              >
                +229 01 91 00 75 56
              </a>
            </div>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <a 
                ...
                className="inline-flex items-center bg-vert-profond text-white px-6 py-3 rounded-full font-semibold hover:bg-opacity-90 transition"
              >
