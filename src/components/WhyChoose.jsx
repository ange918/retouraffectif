  ...
  const reasons = [
    {
      ...
      icon: (
        <svg className="w-10 h-10 sm:w-12 sm:h-12 text-dore" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
          {reasons.map((reason, index) => (
            <div 
              key={index}
              className="bg-gradient-to-br from-vert-clair to-white p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
            >
